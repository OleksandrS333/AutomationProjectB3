...
public class DocuporConstants {
    ...
    public static final String Conformation_MESSAGE = "We've sent you an email with a link to reset your password. Please check your email";
}
